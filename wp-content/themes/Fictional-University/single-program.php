<?php
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="generic-content">
      <?php the_field('program_main_content'); ?>
  </div>
  </div>
  <?php


  // quering and display related Professors
  ...
  // quering and display related events
    $today = date('Ymd');
    ...
    if ($homepageEvents -> have_posts()) {
     ...
     wp_reset_postdata();
     echo '<hr class="section-break">';
     // Check for related campuses
     $relatedCampuses = get_field('related_campus');
     if ($relatedCampuses) {
       echo '<h2 class="headline headline--medium"> Is Available At This Campuses:></h2>';
