    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <!-- Block the dynamic navigation menu
          // <?php
          //  wp_nav_menu(array(
        ...
        <div class="site-header__util">
          ...
          <!--  <a href="<?php echo wp_login_url(); ?>" class="btn btn--small btn--orange float-left push-right">Login</a>
            ...
            <a href="<?php echo wp_login_url(); ?>" class="btn btn--small btn--orange float-left push-right lrm-login">Login</a>
              <a href="<?php echo wp_registration_url(); ?>" class="btn btn--small  btn--dark-orange float-left lrm-signup">Sign Up</a>
          <?php } ?>
